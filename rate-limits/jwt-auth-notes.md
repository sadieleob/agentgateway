...
JWT auth configured on `agentgateway-routing-demo` gateway using Microsoft Entra ID (tenant `e7266048-a758-4738-b82b-1213bc9ad6ba`) as the identity provider.
...
| Issuer | `https://sts.windows.net/e7266048-a758-4738-b82b-1213bc9ad6ba/` (v1.0 — confirmed from token) |
| JWKS path | `e7266048-a758-4738-b82b-1213bc9ad6ba/discovery/v2.0/keys` |
...
```bash
curl -s "https://login.microsoftonline.com/e7266048-a758-4738-b82b-1213bc9ad6ba/v2.0/.well-known/openid-configuration" | jq
```

Key fields:
- `issuer`: `https://login.microsoftonline.com/e7266048-a758-4738-b82b-1213bc9ad6ba/v2.0`
- `jwks_uri`: `https://login.microsoftonline.com/e7266048-a758-4738-b82b-1213bc9ad6ba/discovery/v2.0/keys`
...
ACCESS_TOKEN=$(curl -s -X POST \
  "https://login.microsoftonline.com/e7266048-a758-4738-b82b-1213bc9ad6ba/oauth2/v2.0/token" \
...
```json
{
  ...
  "iss": "https://sts.windows.net/e7266048-a758-4738-b82b-1213bc9ad6ba/",
  "ver": "1.0",
